...
const operationConfig = createDomainOperationConfig("Stations: Web Hooks");

export class AzuraCastStationsWebHooks implements INodeType {
	description: INodeTypeDescription = {
		displayName: "AzuraCast Stations Web Hooks",
		name: "azuraCastStationsWebHooks",
		icon: 'file:azuracast.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operationId"]}}',
		description: "Execute AzuraCast Web API operations for Stations: Web Hooks",
		defaults: {
			name: "AzuraCast Stations Web Hooks",
		},
		usableAsTool: true,
