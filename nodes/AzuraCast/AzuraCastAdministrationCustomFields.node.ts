...
const operationConfig = createDomainOperationConfig("Administration: Custom Fields");

export class AzuraCastAdministrationCustomFields implements INodeType {
	description: INodeTypeDescription = {
		displayName: "AzuraCast Administration Custom Fields",
		name: "azuraCastAdministrationCustomFields",
		icon: 'file:azuracast.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operationId"]}}',
		description: "Execute AzuraCast Web API operations for Administration: Custom Fields",
		defaults: {
			name: "AzuraCast Administration Custom Fields",
		},
		usableAsTool: true,
