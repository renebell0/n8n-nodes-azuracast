...
const operationConfig = createDomainOperationConfig("Stations: General");

export class AzuraCastStationsGeneral implements INodeType {
	description: INodeTypeDescription = {
		displayName: "AzuraCast Stations General",
		name: "azuraCastStationsGeneral",
		icon: 'file:azuracast.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operationId"]}}',
		description: "Execute AzuraCast Web API operations for Stations: General",
		defaults: {
			name: "AzuraCast Stations General",
		},
		usableAsTool: true,
