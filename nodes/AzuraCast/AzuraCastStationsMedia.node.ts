...
const operationConfig = createDomainOperationConfig("Stations: Media");

export class AzuraCastStationsMedia implements INodeType {
	description: INodeTypeDescription = {
		displayName: "AzuraCast Stations Media",
		name: "azuraCastStationsMedia",
		icon: 'file:azuracast.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operationId"]}}',
		description: "Execute AzuraCast Web API operations for Stations: Media",
		defaults: {
			name: "AzuraCast Stations Media",
		},
		usableAsTool: true,
