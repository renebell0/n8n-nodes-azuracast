...
const operationConfig = createDomainOperationConfig("Stations: Streamers/DJs");

export class AzuraCastStationsStreamersDjs implements INodeType {
	description: INodeTypeDescription = {
		displayName: "AzuraCast Stations Streamers DJs",
		name: "azuraCastStationsStreamersDjs",
		icon: 'file:azuracast.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operationId"]}}',
		description: "Execute AzuraCast Web API operations for Stations: Streamers/DJs",
		defaults: {
			name: "AzuraCast Stations Streamers DJs",
		},
		usableAsTool: true,
