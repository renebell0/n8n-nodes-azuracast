...
const operationConfig = createDomainOperationConfig("Stations: Playlists");

export class AzuraCastStationsPlaylists implements INodeType {
	description: INodeTypeDescription = {
		displayName: "AzuraCast Stations Playlists",
		name: "azuraCastStationsPlaylists",
		icon: 'file:azuracast.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operationId"]}}',
		description: "Execute AzuraCast Web API operations for Stations: Playlists",
		defaults: {
			name: "AzuraCast Stations Playlists",
		},
		usableAsTool: true,
