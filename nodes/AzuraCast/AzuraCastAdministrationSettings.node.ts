...
const operationConfig = createDomainOperationConfig("Administration: Settings");

export class AzuraCastAdministrationSettings implements INodeType {
	description: INodeTypeDescription = {
		displayName: "AzuraCast Administration Settings",
		name: "azuraCastAdministrationSettings",
		icon: 'file:azuracast.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operationId"]}}',
		description: "Execute AzuraCast Web API operations for Administration: Settings",
		defaults: {
			name: "AzuraCast Administration Settings",
		},
		usableAsTool: true,
