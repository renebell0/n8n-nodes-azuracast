...
const operationConfig = createDomainOperationConfig("My Account");

export class AzuraCastMyAccount implements INodeType {
	description: INodeTypeDescription = {
		displayName: "AzuraCast My Account",
		name: "azuraCastMyAccount",
		icon: 'file:azuracast.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operationId"]}}',
		description: "Execute AzuraCast Web API operations for My Account",
		defaults: {
			name: "AzuraCast My Account",
		},
		usableAsTool: true,
