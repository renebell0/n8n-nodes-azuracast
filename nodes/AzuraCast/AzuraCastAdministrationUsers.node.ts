...
const operationConfig = createDomainOperationConfig("Administration: Users");

export class AzuraCastAdministrationUsers implements INodeType {
	description: INodeTypeDescription = {
		displayName: "AzuraCast Administration Users",
		name: "azuraCastAdministrationUsers",
		icon: 'file:azuracast.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operationId"]}}',
		description: "Execute AzuraCast Web API operations for Administration: Users",
		defaults: {
			name: "AzuraCast Administration Users",
		},
		usableAsTool: true,
