...
const operationConfig = createDomainOperationConfig("Stations: Mount Points");

export class AzuraCastStationsMountPoints implements INodeType {
	description: INodeTypeDescription = {
		displayName: "AzuraCast Stations Mount Points",
		name: "azuraCastStationsMountPoints",
		icon: 'file:azuracast.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operationId"]}}',
		description: "Execute AzuraCast Web API operations for Stations: Mount Points",
		defaults: {
			name: "AzuraCast Stations Mount Points",
		},
		usableAsTool: true,
