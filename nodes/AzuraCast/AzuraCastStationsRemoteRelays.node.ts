...
const operationConfig = createDomainOperationConfig("Stations: Remote Relays");

export class AzuraCastStationsRemoteRelays implements INodeType {
	description: INodeTypeDescription = {
		displayName: "AzuraCast Stations Remote Relays",
		name: "azuraCastStationsRemoteRelays",
		icon: 'file:azuracast.svg',
		group: ['transform'],
		version: 1,
		subtitle: '={{$parameter["operationId"]}}',
		description: "Execute AzuraCast Web API operations for Stations: Remote Relays",
		defaults: {
			name: "AzuraCast Stations Remote Relays",
		},
		usableAsTool: true,
